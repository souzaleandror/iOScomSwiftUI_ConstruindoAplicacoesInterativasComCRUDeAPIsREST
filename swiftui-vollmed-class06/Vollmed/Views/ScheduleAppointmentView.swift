...
struct ScheduleAppointmentView: View {
    ...
    func rescheduleAppointment() async {
        ...
        do {
            if let _ = try await service.recheduleAppointment(appointmentID: appointmentID, date: selectedDate.convertToString())
            {
            ...
            print("Ocorreu um erro ao recarmar consulta: \(error)")
            isAppointmentScheduled = false
        }
        showAlert = true
